    ...
    extends AbstractPlaceHistoryMapper
{
    ...
    protected Place getPlaceFromToken( String token )
    {
        ...
        else if ( token.startsWith( NameTokens.FILL_AREA ) )
        {
            return new FillAreaPlace();
        }
        else if ( token.startsWith( NameTokens.ERROR_BARS ) )
        {
    ...
    protected String getTokenFromPlace( Place place )
    {
        ...
        else if ( place instanceof FillAreaPlace )
        {
            return NameTokens.FILL_AREA;
        }
